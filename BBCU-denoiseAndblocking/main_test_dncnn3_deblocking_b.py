...
def main():
    ...
    LIVE1_root = "/root/datasets/testsets/LIVE1"
    classic5_root = "/root/datasets/testsets/classic5"
    dataset = [LIVE1_root,classic5_root]
    model_list = ["./checkpoints/BBCU-deblocking.pth"]
    model_name_list = ['dncnn3']
    testset_name_list = ["live1","classic5"]
    ...
    for i in range(len(dataset)):
        for j in range(len(model_list)):
            for quality_factor in quality_factor_list:
                ...
                result_name = args.testset_name + "_%02d"%(quality_factor)+'_' + args.model_name     # fixed
                ...
                from models.network_dncnn3_bin import DnCNN as net
                ...
                for idx, img in enumerate(L_paths):
                    ...
                    util.imshow(img_L, title='Noisy image with noise level {}'.format(args.noise_level_img)) if args.show_img else None
