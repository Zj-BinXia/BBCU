...
from quants.quant_convs_react import RPReLU,BinaryConv2d
...
# --------------------------------------------
'''
def default_binary_conv(in_channels, out_channels, kernel_size, bias=True):
    return BinaryConv2d(
        in_channels,
        out_channels,
        kernel_size,
